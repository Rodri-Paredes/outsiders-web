-- ====================================================================================================
-- Migración: Agregar campo customer_phone a la tabla sales
-- Fecha: 2026-02-13
-- Descripción: Agregar campo para almacenar el celular del cliente en las ventas
-- ====================================================================================================

-- Agregar columna customer_phone a la tabla sales
ALTER TABLE sales 
ADD COLUMN IF NOT EXISTS customer_phone TEXT;

COMMENT ON COLUMN sales.customer_phone IS 'Número de celular del cliente (opcional)';

-- ====================================================================================================
-- Actualizar función create_complete_sale para incluir customer_phone
-- ====================================================================================================
...
BEGIN
  ...
  -- Crear la venta (ahora incluye customer_phone)
  INSERT INTO sales (
...
COMMENT ON FUNCTION create_complete_sale IS 'Crea una venta completa de forma transaccional con todas las validaciones necesarias. Los triggers automáticos descuentan stock y registran en caja. Incluye campo opcional de celular del cliente.';
