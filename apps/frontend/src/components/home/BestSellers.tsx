...
// Los productos ya vienen resueltos desde el servidor (ver app/page.tsx y
// app/best-sellers/page.tsx + homeCatalog.server.ts, cacheados 60s) — este
// componente solo se encarga de la animación y el render.
export function BestSellers({ config, products }: Props) {
